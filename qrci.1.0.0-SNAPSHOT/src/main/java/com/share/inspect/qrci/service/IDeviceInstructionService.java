 ...
 */
public interface IDeviceInstructionService {
     ...
     * @date: 2018-8-28 20:54:06
     */
    PageInfo<DeviceInstruction> selectByPage(Map
     ...
     * @date: 2018-8-28 20:54:06
     */
    Integer insert(DeviceInstruction deviceInstruction) throws Exception;
     ...
     * @date: 2018-8-28 20:54:06
     */
    Integer updateById(DeviceInstruction deviceInstruction) throws Exception;
     ...
     * @date: 2018-8-28 20:54:06
     */
    DeviceInstruction selectById(Long id) throws Exception;
