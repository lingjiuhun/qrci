...
public class MybatisUtil {
    ...
    public static void main(String[] args) {
        ...
        try {
//    		creatBean();
            MybatisUtil.autoMakeBean("127.0.0.1:3306/mytest?useUnicode=true&amp;characterEncoding=utf-8&amp;useSSL=false", "root", "root@123",
                    "main.java.com.hollysys.hollipark.dispatching.core.enter", "UserInfo", "t_user_info");
