...
*/
@Override
public PageInfo<${simpleclassName}> selectByPage(Map
...
Integer r = 0;
//主键存在判断
if (${simpleclassName?uncap_first} == null || ${simpleclassName?uncap_first}.getId() == null) {
return r = -1;
}
//唯一性判断
...
//数据删除
r = ${simpleMapperName?uncap_first}.deleteByPrimaryKey(id);
